...
$_lang['extratextareas'] = 'Дополнительные текстовые области';
$_lang['extratextareas.menu_desc'] = 'Настройка дополнительных текстовых полей ресурса';
$_lang['extratextareas.field_name'] = 'Системное имя';
$_lang['extratextareas.field_caption'] = 'Название';
$_lang['extratextareas.field_description'] = 'Описание';
$_lang['extratextareas.field_active'] = 'Активно';
$_lang['extratextareas.field_rank'] = 'Порядок';
$_lang['extratextareas.field_create'] = 'Создать поле';
$_lang['extratextareas.field_remove'] = 'Удалить поле';
$_lang['extratextareas.field_remove_confirm'] = 'Удалить выбранное поле?';
$_lang['extratextareas.field_err_required'] = 'Заполните системное имя и название';
